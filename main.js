...
// descs[checkpoint].classList.add('current');
...
//     descs[checkpoint + 1].classList.add('in-progress');
// } catch(error) {}
...
function toggle_active(element) {
    ...
    // const stir_fries = document.querySelectorAll('.stir > .fry');
    // for (const meal of stir_fries) {
    //     try {
    //         meal.querySelector('.accordion').classList.remove('active');
    //     } catch(error) {}
    // }
}